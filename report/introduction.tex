...
During this experiments, I found two bugs in SafraFT.
We could fix those without much change and the results presented later are runs on the fixed version of SafraFT.
