...
When the extended version is used SafraFT detects early termination in only 14 out of 1124 runs with crashes and in only 2 cases, this leads to a corrupted result. % NUMBER
...
For both fault scenarios of five or less failing nodes and 90\% node failure on all network sizes, at most 3 times as many tokens were sent as for a fault free run. %NUMBER.
