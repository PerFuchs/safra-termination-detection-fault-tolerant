...
Furthermore, the low processing time overhead (less than NUMBER)  % NUMBER
...
An interesting starting point for further research on this topic can be found in the literature about self-stabilizing algorithms which use the notion of \texit{final fault}.
