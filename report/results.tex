...
I would like to note that the low processing time overhead of Safra (maximum of %TODO) 
is not in contradiction to the large amount of wall time spent after termination (maximum of %TODO).
