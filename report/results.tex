...
% TODO write about Chandy Misra verification?
...
More so highly faulty networks more faults. The data is presented \cref{fig:tokens-and-tokens-after-faulty} and \cref{table:tokens-faulty}. % Table presents comparision with 0 configuration
