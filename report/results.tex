...
The raw data used for this report can be found TODO here.
...
According to the extended definition, it detects termination to early in 13 out 1124 runs with crashes.  % NUMBER NUMBER
...
This is most likely due to the fact that 2000 nodes networks were simulated by running 100 instances instead of 50 instances per physical node.
...
Total times in faulty networks are presented in tables~\ref{table:total-times-faulty-cm} and \ref{table:total-times-aky}.
