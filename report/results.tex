...
The data is presented \cref{fig:tokens-and-tokens-after-faulty} and \cref{table:tokens-faulty}. % Table presents comparision with 0 configuration
...
% TODO put differences togeether with number and put after extra?
\begin{table}
	\centering
	\begin{tabular}{rrrrrr||rrrrr}%
		\toprule
...
\end{table}
 ...
 There is no clear realtionship between network size and the overhead caused by the 5n sceanrio.
