...
To proof termination is not detected to early, I use offline analysis (see \cref{ssec:offlineanalysis}) to determine the point of actual termination and verify that detection happened after.
...
\begin{table}
	\begin{tabular}{rrrrrr}%
		...
		\\\bottomrule
	\end{tabular}
	\caption{Processing times before and after termination (in braces). For different fault scenarios compared to fault-free networks.}
...
\end{table}
 ...
 \begin{table}
 	\begin{tabular}{rrrrrr}%
 		...
 		\\\bottomrule
 	\end{tabular}
 	\caption{Total times before and after termination (in braces). For different fault scenarios compared to fault-free networks.}
 ...
 % TODO why does total time after for less faulty networks not increase.
    ...
    \begin{landscape}
 \begin{figure}
 	\frame{\includegraphics[trim={1cm 55cm 1cm 2cm},clip,width=23cm]{figures/total-times-faulty.png}}
 \end{figure}
 \begin{figure}
 	\includegraphics[trim={1cm 55cm 1cm 2cm},clip,width=23cm]{figures/processing-times-faulty.png}
 \end{figure}
 \begin{figure}
 	\includegraphics[trim={1cm 55cm 1cm 2cm},clip,width=23cm]{figures/tokens-faulty.png}
 \end{figure} 
    \end{landscape}
