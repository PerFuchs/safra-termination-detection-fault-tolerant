...
In this case \co{Y} sends no \co{DIST} message as answer to \co{X}.

Next, I present an intuition why this extentsion is fault-tolerant.
...
After implementation and successful testing of this optimization, I realized, by reading the original Afek-Kutten-Yung paper, that this variation could lead to infinite runs. % TODO cite
...
% TODO known bugs section: CM, null pointer in validation of AKY?
